...
.app-input {
  width:100%; border:1px solid #e7e7ea; border-radius:10px; padding:12px 12px; font-size:14px; outline: none;
}
.app-input:focus { border-color:#2f7ef4; box-shadow:0 0 0 3px rgba(47,126,244,.15); }
.app-hint { margin:6px 0 0; font-size:12px; color:#667085; }
