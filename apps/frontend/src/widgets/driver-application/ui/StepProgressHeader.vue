<template>
  <header class="apply-progress mb-4">
    <div class="apply-progress__steps mb-2 flex gap-4">
      ...
      >
        <span
          class="index inline-flex h-6 w-6 items-center justify-center rounded-full border border-slate-200 text-[11px] font-bold text-slate-700"
        >
          01
        </span>
...
.apply-progress__step.is-done .index {
  ...
  background: rgb(var(--c-success-light));
  color: rgb(var(--c-success));
}
</style>
