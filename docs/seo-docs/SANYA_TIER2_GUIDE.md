...
## 4.5. Hero — самый важный блок страницы (ЖЕЛЕЗНО)

> Hero (первый экран — kicker + H1 + lead-параграф 70–150 слов) — это блок, на котором решается всё. Google смотрит на него первым, читатель смотрит на него первым, и именно по нему классификаторы решают «AI-спам или нормальный контент».

### Почему hero нельзя отдавать AI «как есть»

AI по умолчанию пишет hero одинаково: «Whether you're driving in X or Y... here's everything you need to know». Это **footprint** — Google видит одинаковую структуру на 50 наших страницах и понижает ВЕСЬ сайт. Поэтому:

1. **Hero пиши/правь сам, вручную.** Все остальные блоки (Rules, Fines, Renting, FAQ) могут быть AI-черновиком с лёгкой редактурой. Hero — нет. На hero тратишь больше всего времени.
2. **Сгенерируй 2-3 варианта hero, выбери лучший.** Не отправляй первый драфт. Скажи Claude «сгенерируй 3 варианта lead-параграфа в разных тональностях», выбери тот который меньше всего звучит как ChatGPT.
3. **Если у соседних 2 страниц (например us-italy и uk-italy) hero одинаковой формы — переписывай.** Один начинается со сцены, другой со штрафа, третий с прямого вердикта.

### ❌ ЗАПРЕЩЁННЫЕ фразы в hero (это AI-маркеры — Google их детектит)

- «Whether you're X or Y...» / «Whether you've booked...» / «Whether you plan to...»
- «Planning a trip to...» / «Heading to...» / «Thinking about driving in...»
- «Here's everything you need to know about...»
- «In this guide, we'll walk you through...»
- «Don't worry — we've got you covered»
- «Buckle up — here's what you need to know» (любые caretaker-фразы)
- Цепочки из 3 параллельных гипотетик: «Whether you... whether you... or whether you...»

Если в драфте от AI есть любая из этих фраз — переписываешь. Можно и нужно сказать AI: «Перепиши без шаблонных фраз вида „Whether you're..., here's everything you need to know"».

### ✅ ОБЯЗАТЕЛЬНЫЕ элементы hero (КАЖДАЯ страница):

1. **Конкретный сценарий.** Не «planning a trip» — а «You've booked a Hertz pickup at FCO for two weeks in May». Названия городов / районов / месяцев — обязательно.
2. **Конкретная цифра с привязкой ко времени или месту.** Не «fines can be high» — а «€175 minimum at the Tulum checkpoint, May 2025» или «$1,094.50 — that's what a Tulum checkpoint cost an Italian tourist last spring». Цифра без даты или места = плохо.
3. **Reframe одной строкой.** Линия которая объясняет ПОЧЕМУ эта страна особенная. «Italian law says you need a Geneva 1949 IDP. Italian rental desks say it in their own way: cash deposit if you can't show one.» Это даёт ощущение что писал человек который реально понимает страну.

### Эталонный пример hero (us-mexico)

Прочитай его в `apps/landing/content/country-pairs/us-mexico.ts` поле `hero.lead`. Он цитирует Tulum май 2025 ($1,094.50) и инцидент с итальянским туристом в Канкуне ($2,566) — конкретно, с датами, без шаблонов. Все Tier 2 страницы должны иметь такого же качества hero.
...
АНТИ-AI-ШАБЛОН ПРАВИЛА (КРИТИЧНО — Google детектит шаблоны):

Запрещённые фразы (нигде на странице, особенно в hero):
- «Whether you're X or Y...» / «Whether you've booked...» / «Whether you plan to...»
- «Planning a trip to...» / «Heading to...» / «Thinking about driving in...»
- «Here's everything you need to know about...»
- «In this guide, we'll walk you through...»
- «Don't worry — we've got you covered»
- Цепочки из 3 параллельных «Whether... whether... or whether...»

Hero (lead 70–150 слов) обязан содержать:
- Конкретный сценарий с названием города/района/месяца (не «planning a trip»)
- Конкретную цифру штрафа/инцидента с привязкой ко времени или месту
- Одну строку reframe — линию объясняющую почему именно эта страна особенная

Сгенерируй 3 варианта hero lead-параграфа в разных тональностях (scene-driven, fines-driven, contrarian), помеченные как Variant A / Variant B / Variant C. Я выберу лучший.
...
- Title (H1): ...
- Lead — сгенерируй ТРИ варианта (Variant A, B, C) в разных тональностях: scene-driven (открытие сценой), fines-driven (открытие конкретным штрафом/инцидентом), contrarian (опровержение распространённого заблуждения). Каждый вариант — 70–150 слов, обязательно с конкретным городом/районом, конкретной цифрой штрафа с датой/местом, и reframe-линией. БЕЗ запрещённых шаблонных фраз.
...
**Hero — отдельная проверка (самое важное):**
- [ ] Hero сгенерирован в 3 вариантах (A / B / C) — выбран лучший, помечен какой именно идёт в финальный файл
- [ ] В выбранном варианте нет ни одной запрещённой фразы: «Whether you're...», «Planning a trip to...», «Heading to...», «Here's everything you need to know», «we've got you covered», цепочек «Whether... whether... whether...»
- [ ] В hero есть хотя бы 1 названный город / район / месяц
- [ ] В hero есть хотя бы 1 конкретная цифра штрафа или инцидента с привязкой ко времени или месту
- [ ] Если в батче есть соседняя пара (например ты делаешь us-italy и uk-italy подряд) — hero у них **разной формы** (одна со сцены, другая со штрафа, или одна-другая контрарианская)
...
- [ ] Папка одной пары содержит ровно эти 2 файла (плюс локализованные `.{locale}.md` если применимо)
